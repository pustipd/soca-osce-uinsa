...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Create New Kriteria</h6>
                   ...
                   @if ($errors->any())
                    ...
                    <form method="POST" action="{{ url('osce/kriteria/store') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}

                        @include ('master.osce.kriteria.form', ['formMode' => 'create'])
