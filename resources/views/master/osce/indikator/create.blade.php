            ...
            <div class="card">
                <div class="card-body">
                   ...
                   @if ($errors->any())
                    ...
                    <form method="POST" action="{{ url('osce/indikator/store') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}

                        @include ('master.osce.indikator.form', ['formMode' => 'create'])
