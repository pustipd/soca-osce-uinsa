<li class="nav-item nav-category">Soca</li>
...
@if (Auth::guard('web')->check())
    <li class="nav-item {{ active_class(['soca/ujian/*']) }}">
        <a href="{{ url('soca/ujian') }}" class="nav-link">
            <i class="link-icon" data-feather="box"></i>
...
@if (Auth::guard('penguji')->check())
    <li class="nav-item {{ active_class(['penguji/*']) }}">
        <a href="{{ url('soca/penguji/list-ujian') }}" class="nav-link">
            <i class="link-icon" data-feather="box"></i>
            <span class="link-title">Dashboard SOCA</span>
        </a>
    </li>
@endif

<li class="nav-item nav-category">Osce</li>
{{-- <li class="nav-item {{ active_class(['admin/dashboard']) }}">
    <a href="{{ url('/admin/dashboard') }}" class="nav-link">
        <i class="link-icon" data-feather="box"></i>
        <span class="link-title">Dashboard</span>
...
@if (Auth::guard('web')->check())
    <li class="nav-item {{ active_class(['osce/ujian/*']) }}">
        <a href="{{ url('osce/ujian') }}" class="nav-link">
            <i class="link-icon" data-feather="box"></i>
            <span class="link-title">Ujian</span>
        </a>
    </li>
...
<li class="nav-item {{ active_class(['penguji/*']) }}">
    <a href="{{ url('osce/penguji/list-ujian') }}" class="nav-link">
        <i class="link-icon" data-feather="box"></i>
        <span class="link-title">Dashboard OSCE</span>
    </a>
</li>
@endif
